...
class Tensor:
    ...
    def expand(self, other: Tensor) -> Tensor:  # noqa: D417
    ...
    def tuple(self) -> Tuple[Storage, Shape, Strides]:  # noqa: D102
        return self._tensor.tuple()

    def detach(self) -> Tensor:  # noqa: D102
